...
uses
  ...
  Vcl.ComCtrls, Vcl.Shell.ShellCtrls, Vcl.ExtDlgs, Vcl.StdCtrls, Vcl.ExtCtrls;
...
procedure TForm1.CheckBoxLabelsClick(Sender: TObject);
begin
  UpdateEverything
end;
...
procedure TForm1.ImageMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
  VAR
    a,b,c,d      :  Double;
